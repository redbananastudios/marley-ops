...
Last touched: 2026-08-05 on i9 — **T-7 flag 24h grace + lost-quote retirement + card-settlement classifier shipped staging→prod** (prod on `bca96aa`; 2026-08-04 shipped inbound-reply readability `9e5bed6` + receipts/backstop `894a54b` — see brain CHANGELOG).
