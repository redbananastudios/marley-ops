...
Last touched: 2026-08-05 on i9 — **card-settlement classifier shipped staging→prod** (prod on `821cb34`; 2026-08-04 shipped inbound-reply readability `9e5bed6` + receipts/backstop `894a54b` — see brain CHANGELOG).
