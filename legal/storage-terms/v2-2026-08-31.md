---json
{
  "id": "storage-terms-v2-2026-08-31",
  "document": "storage-terms",
  "title": "Storage Agreement Terms",
  "version": 2,
  "effective_from": "2026-08-31",
  "effective_to": null,
  "supersedes": "storage-terms-v1-2026-08-11",
  "approved_by": "Peter Farrell",
  "approved_at": "2026-08-31",
  "source": "Payment-method clarification approved by Peter Farrell on 31 August 2026. Existing billing and release timing is unchanged. NOT yet reviewed by a solicitor. The lien notice procedure in section 8 specifically needs a solicitor to confirm it is enforceable.",
  "summary": "Clarifies that storage payments can be made by card, bank transfer or cash, with bank transfer preferred and no card surcharge. All charges still have to be settled before release.",
...
- A **minimum period of one calendar month**, invoiced upfront at £84 including VAT per crate. This minimum is payable in full even if you take your belongings out sooner.
- After the minimum calendar month ends, storage is charged **to the exact day** at £3 including VAT per crate per day. We invoice in arrears every 4 weeks, and the final invoice runs only to the date your belongings leave storage.
...
- Storage charges can be paid by bank transfer, card or cash. Bank transfer is preferred. We do not add a card fee. We do not take a storage deposit.

## 4. Ending your storage, and getting your belongings back

- You can end your storage at any time by telling us, subject to the one-calendar-month minimum for crates and the container final-period rule in section 3.
