...
export function CrewManual() {
  return (
    <div className="max-w-3xl">
      ...
      {/* Walkthrough video — same-origin asset in public/training (regenerated by
          the role-training-materials pipeline). Hidden in print (it is a video). */}
      <figure className="mt-6 overflow-hidden rounded-xl border border-border bg-card print:hidden">
        <div className="border-b border-border px-4 py-2.5">
          <p className="eyebrow">Watch first · 3 minutes</p>
        </div>
        <video
          controls
          preload="metadata"
          poster="/training/crew-poster.jpg"
          className="block aspect-video w-full bg-black"
        >
          <source src="/training/crew.mp4" type="video/mp4" />
          Your browser cannot play this video. Read the nine parts below instead.
        </video>
        <figcaption className="px-4 py-2.5 text-xs text-mist-400">
          A quick walkthrough of your day. No sound? The words are on screen. The nine parts below say the same
          thing, step by step.
        </figcaption>
      </figure>
